...
// ##### ST7735 setup #####
#if defined(SHOW_SPIRIT_LEVEL_WIDGET)
...
#if defined(SHOW_MONITORING_WIDGET)
MonitoringWidgets my_monitoring_widget = MonitoringWidgets(&mpu, cfg_monitoring_text, SSD1306_CANVAS_FORMAT, &right_display);
#endif // SHOW_MONITORING_WIDGET
...
#if defined(SHOW_MONITORING_WIDGET)
    xTaskCreate(I2C_display_gate_keeper_task, "I2C_gate_keeper_task", 256, &p1, 6, NULL);
    xTaskCreate(my_mpu_monitoring_task, "mpu_monit", 256, NULL, 10, &my_monitoring_widget.task_handle);
#endif // SHOW_MONITORING_WIDGET

#if defined(SHOW_SPIRIT_LEVEL_WIDGET)
    xTaskCreate(SPI_display_gate_keeper_task, "SPI_gate_keeper_task", 256, &p5, 7, NULL);
    xTaskCreate(my_mpu_spirit_level_task, "spirit_level", 256, &p4, 11, &my_spirit_level_widget.task_handle);
#endif // SHOW_SPIRIT_LEVEL_WIDGET
